...
function DashboardPage() {
  ...
  const contentManagerStat = useSWR<PaginatedInterface<ContentManagerInterface>>(
    () => `/content-managers`,
    () => getContentManagers({ limit: 1, offset: 0 }),
  );
  ...
  const statResults: { title: string; result: number; change: number; isLoading: boolean }[] = [
    {
      ...
      result: contentManagerStat?.data?.totalCount,
      isLoading: contentManagerStat.isLoading,
