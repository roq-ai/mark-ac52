...
import { getWatermarkById } from 'apiSdk/watermarks';
import { WatermarkInterface } from 'interfaces/watermark';

function WatermarkViewPage() {
            ...
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              <Flex alignItems="center" w="full" justifyContent={'space-between'}>
                ...
                {hasAccess('watermark', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
                  <NextLink href={`/watermarks/edit/${id}`} passHref legacyBehavior>
                    <Button
              ...
              >
                <FormListItem label="Design" text={data?.design} />

                <FormListItem label="Placement" text={data?.placement} />
