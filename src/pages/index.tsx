  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Experience the ultimate protection with Mark - Ensuring your videos and images remain distinctively yours, even when cropped. Safeguarding your creativity, one watermark at a time."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1579846703786-afbf4b377f7e?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHx3YXRlcm1hcmt8ZW58MHx8fHwxNjk0MDY3MzEzfDA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Experience the ultimate protection with Mark - Ensuring your videos and images remain distinctively yours, even when cropped. Safeguarding your creativity, one watermark at a time.`}
            </Text>
            <Box
