...
export function AdministratorListPage(props: AdministratorListPageProps) {
  ...
  const fetcher = useCallback(
    async () =>
      getAdministrators({
        relations: ['user', 'watermark.count'],
  ...
  const columns: ColumnType[] = [
    ...
    hasAccess('user', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ...
      : null,
    hasAccess('watermark', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          id: 'watermark',
          header: 'Watermark',
          accessorKey: 'watermark',
          cell: ({ row: { original: record } }: any) => record?._count?.watermark,
        }
      : null,
